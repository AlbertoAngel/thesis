...
\beq
\opa = \mymtx{0 \sqrt{1} 0 0 \ldots;0 0 \sqrt{2} 0 \ldots;0 0 0 \sqrt{3} \ldots;\vdots \vdots \vdots \vdots \ddotsl} ~ \opaa = \mymtx{0 0 0 \ldots;\sqrt{1} 0 0 \ldots;0 \sqrt{2} 0 \ldots;0 0 \sqrt{3} \ldots;\vdots \vdots \vdots \ddotsl}
\eeq
